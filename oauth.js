...
app.get('/getBalances', function(req, res){
  // consumer.get(apiHost + "/obp/v4.0.0/banks/hsbc.01.hk.hsbc/balances",
  ...
  //   }
  // });
  var template = "./template/balances.pug";
  var title = "Balances"
...
app.get('/getConfig', function(req, res){
  consumer.get(apiHost + "/obp/v4.0.0/config",
  req.session.oauthAccessToken,
  req.session.oauthAccessTokenSecret,
  function (error, data, response) {
    try {
...
app.get('/getCustomers', function(req, res){
  consumer.get(apiHost + "/obp/v3.0.0/users/current/customers",
  req.session.oauthAccessToken,
  req.session.oauthAccessTokenSecret,
  function (error, data, response) {
    try {
